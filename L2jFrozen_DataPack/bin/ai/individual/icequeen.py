 ...
 def onAdvEvent (self,event,npc,player):
   if event == "prosnuca" :
     ...
     if player:
       ...
       return "<html><body><font color=LEVEL>Se acabo el tiempo...</font></body></html>"
   ...
   if npcId == STEWARD :
     if st.getQuestItemsCount(HEMOSYCLE) >= 10 :
       if closed == "" :
         ...
         return "<html><body>El Raid actualmente esta <font color=LEVEL>en proceso.<font>.<br> Prueba mas tarde.</body></html>"
     else : 
