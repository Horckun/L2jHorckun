  ...
  def onTalk(self, npc, player) :
    ...
    if castleOwner and clanId :
      if castleOwner == clanId :
        ...
        htmltext = "<htm><body><font color='LEVEL'>Avatar de Benom:</font><br><br>Tu clan no posee este castillo. Solo los miembros del clan propietario de este castillo pueden desafiar a Benom.</body></htm>"
    else :
      htmltext = "<htm><body><font color='LEVEL'>Avatar de Benom:</font><br><br>Tu clan no posee este castillo. Solo los miembros del clan propietario de este castillo pueden desafiar a Benom.</body></htm>"
    return htmltext
